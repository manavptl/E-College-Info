<?php
    ...
    $sql = "select id,filename,upload_date from attendance order by id desc ";
    ...
    <div class="main">
        ...
        <span>File name must be unique and related to the content of the file.</span>
            <div class="cointainer">
                <input class="inp" type="file" name="fatt" required style="padding-left:10px;">
                
            </div>
        
            <div class="button">
                <input type="submit" class="button1" value="Upload" name="upload_att">
            </div>
            <?php
        ...
        <table class="table">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td><a href="upload/Attendance/<?php echo $row['filename']; ?>" download>Download</td>
                    <td>
                        <form action="delete Master.php" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="submit" name="delete_att" value="Delete"  onclick="return checkdelete()">
                        </form>
                    </td>
                </tr>
                <?php } ?>
