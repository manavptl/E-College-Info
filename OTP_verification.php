...
<body>
    ...
    <div class="main">
        ...
        <form method="POST" action="OTP_verification_backend.php" class="form">
            ...
            <div class="cointainer">
                <input class="otp" type="password" name="verify-otp" maxlength="6" required >
                <span>OTP</span>
