...
<body>
    ...
    <form method="post" action="Student_update.php" class="form">
    ...
    <?php $id = $row['u_id'];
            ...
            $Query_student_info= "SELECT * FROM student_info where u_id='$id' ";
        ...
        ?>    
                ...
                <div class="cointainer">
                    <input class="inp" type="text" name="f_m_n" value="<?php echo $row['father_mno'] ?>" required>
                    <span>Father Mobile Number</span>
                    <i class="fa fa-user icon fa-lg"></i>
                </div>
                <div class="cointainer" id="password">
                    <input class="inp" type="text" name="p_adress" value="<?php echo $row['father_address'] ?>" required>
                    <span>Parents Address</span>
                    <i class="fa fa-lock fa-lg" aria-hidden="true"></i>
                </div>
         
                <div class="cointainer">
                    <input class="inp" type="text" name="eno" value="<?php echo $row['enrolment'] ?>" required>
                    <span>Enrollnment Number</span>
                    <i class="fa fa-user icon fa-lg"></i>
                </div>
                <div class="cointainer">
                    <input class="inp" type="text" name="category" value="<?php echo $row['category'] ?>" required>
                    <span>category</span>
                    <i class="fa fa-user icon fa-lg"></i>
                </div>
                <div class="cointainer">
                    <input class="inp" type="text" name="updown" value="<?php echo $row['up_down'] ?>" required>
                    <span>UP-Down</span>
                    <i class="fa fa-user icon fa-lg"></i>
                </div>
               
                <div class="cointainer">
                    <input class="inp" type="text" name="sem" value="<?php echo $row['sem'] ?>" required>
