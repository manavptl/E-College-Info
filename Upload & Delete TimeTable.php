<?php
    ...
    $sql = "select id,filename,upload_date from timetable order by id desc ";
    ...
    <div class="main">
        ...
        <span>File name must be unique and related to the content of the file.</span>
            <div class="cointainer">
                <input class="inp" type="file" name="ftime" required style="padding-left:10px;">
                
            </div>
        
            <div class="button">
                <input type="submit" class="button1" value="Upload" name="upload_time">
            </div>
            <?php
        ...
        <table class="table">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td><a href="upload/Time Table/<?php echo $row['filename']; ?>" download>Download</td>
                    <td>
                        <form action="delete Master.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="delete_id" value="<?php echo $row['id']; ?> "> 
                            <input type="hidden" name="File_name" value="<?php echo $row['filename']; ?> ">
                            <input type="submit" name="delete_time" value="Delete"  onclick="return checkdelete()">
                        </form>
                    </td>
                </tr>
                <?php } ?>
