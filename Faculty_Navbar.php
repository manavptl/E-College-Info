...
@media all and (max-width: 320px) 
{
  ...
  <body>
    <nav>
      ...
      <ul>
        <li><a href="Faculty Home.php">Home</a></li>
        <li>
          <label for="btn-2" class="show">May I Help ? +</label>
          <a href="#">May I Help ?</a>
          <input type="checkbox" id="btn-2" style="display: none;">
          <ul class="rare">
        ...
        <li>
          ...
          <a href="#">Materials</a>
          <input type="checkbox" id="btn-4" style="display: none;">
          <ul>
        ...
        <li>
          ...
          <a href="#">Downloads</a>
          <input type="checkbox" id="btn-1" style="display: none;">
          <ul>
            <li><a href="Upload & Delete Notice.php">Notice</a></li>
            <li><a href="Upload & Delete Assignment.php">Assignment</a></li>
            <li><a href="Upload & Delete Attendance.php">Attendance</a></li>
            <li><a href="Upload & Delete TimeTable.php">Time Table</a></li>
            <li><a href="Upload & Delete Result.php">Result</a></li>
          </ul>
        </li>
        <li><a href="Faculty About us.php">About Us</a></li>
        <li>
        ...
        <a href="#"><i class="fa fa-user-circle-o fa-2x" aria-hidden="true"></i></a>
          ...
          <ul>
            <li><a href="Faculty_current_details.php">Edit Profile</a></li>
